...
class Conv(nn.Module):
    ...
    def __init__(self, dim):
        ...
        self.dwconv = nn.Conv2d(dim, dim, kernel_size=7, groups=dim, padding="same")  # depthwise conv
        ...
        self.dwconv2 = nn.Conv2d(dim, dim, kernel_size=7, groups=dim, padding="same")  # depthwise conv
